	...
	<div class="row">
		<div class="col-lg-8 mx-auto">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<form action="<?php echo e(route('pengumuman.update', $pengumuman)); ?>" method="POST">
						<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
								rows="5" required placeholder="Tulis isi pengumuman di sini..."><?php echo e(old('isi', $pengumuman->isi)); ?></textarea>
							</div>
							<small class="form-text text-muted">
								<i class="fas fa-info-circle"></i> Tulis pengumuman yang ingin disampaikan kepada jamaah
							</small>
							<div class="mt-2 text-muted small">
								<span id="charCount"><?php echo e(strlen($pengumuman->isi)); ?></span> karakter
							</div>
							<?php $__errorArgs = ['isi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>" 
								value="<?php echo e(old('tanggal', $pengumuman->tanggal)); ?>" required>
							</div>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="card bg-light mb-3">
							...
							<div class="card-body">
								<div id="previewContent"><?php echo e(nl2br(e($pengumuman->isi))); ?></div>
							</div>
						</div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\PROJECT LARAVEL\MASJID-DIGITAL-V2\resources\views\pengumuman\edit.blade.php ENDPATH**/ ?>