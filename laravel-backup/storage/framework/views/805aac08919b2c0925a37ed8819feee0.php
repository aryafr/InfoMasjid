                            ...
                            <div class="p-5">
                                ...
                                <form method="POST" action="<?php echo e(route('password.email')); ?>" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="email" class="form-control form-control-user" name="email" placeholder="Alamat Email" value="<?php echo e(old('email')); ?>" required>
                                    </div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\PROJECT LARAVEL\MASJID-DIGITAL-V2\resources\views\auth\passwords\email.blade.php ENDPATH**/ ?>