...
<head>
    ...
    <meta name="description" content="<?php echo e($setting['nama_aplikasi'] ?? 'Sistem Informasi Masjid Digital'); ?>">
    <meta name="author" content="Ali Mochtar Development System">

    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
    <title><?php echo e($setting['nama_aplikasi'] ?? config('app.name', 'SIMasjid')); ?> - Panel Admin</title>
...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(url('/home')); ?>">
                ...
                <div class="sidebar-brand-text mx-2">
                    <small><?php echo e(Str::limit($setting['nama_aplikasi'] ?? config('app.name', 'SIMasjid'), 15)); ?></small>
                </div>
            </a>
            ...
            <li class="nav-item <?php echo e(request()->routeIs('jadwal_sholat.*') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('jadwal_sholat.index')); ?>">
            ...
            <li class="nav-item <?php echo e(request()->routeIs('sholat_jumat.*') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('sholat_jumat.index')); ?>">
            ...
            <li class="nav-item <?php echo e(request()->routeIs('idul-fitri.*') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('idul-fitri.index')); ?>">
            ...
            <li class="nav-item <?php echo e(request()->routeIs('idul-adha.*') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('idul-adha.index')); ?>">
            ...
            <!-- Nav Item - Pengumuman -->
            <li class="nav-item <?php echo e(request()->routeIs('pengumuman.*') ? 'active' : ''); ?>">
            ...
            <!-- Nav Item - Keuangan -->
            <li class="nav-item <?php echo e(request()->routeIs('keuangan.*') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('keuangan.index')); ?>">
            ...
            <!-- Nav Item - QRIS -->
            <li class="nav-item <?php echo e(request()->routeIs('qris.*') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('qris.index')); ?>">
            ...
            <li class="nav-item <?php echo e(request()->routeIs('auto_update.*') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('auto_update.index')); ?>">
            ...
            <li class="nav-item <?php echo e(request()->routeIs('rotation.*') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('rotation.index')); ?>">
                    <i class="fas fa-fw fa-exchange-alt"></i>
                    <span>Rotasi Halaman TV</span>
                    <?php if($setting->rotation_enabled ?? true): ?>
                    <span class="badge badge-success ml-2" style="font-size: 9px;">AKTIF</span>
                    <?php else: ?>
                    <span class="badge badge-secondary ml-2" style="font-size: 9px;">NONAKTIF</span>
                    <?php endif; ?>
            ...
            <li class="nav-item <?php echo e(request()->routeIs('settings.*') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('settings.edit')); ?>">
            ...
            <div id="collapseExport" class="collapse" aria-labelledby="headingExport" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="<?php echo e(route('export.jadwal-sholat')); ?>">
                        <i class="fas fa-clock text-primary"></i> Jadwal Sholat
                    </a>
                    <a class="collapse-item" href="<?php echo e(route('export.pengumuman')); ?>">
                        <i class="fas fa-bullhorn text-warning"></i> Pengumuman
                    </a>
                    <a class="collapse-item" href="<?php echo e(route('export.keuangan')); ?>">
        ...
        <li class="nav-item <?php echo e(request()->routeIs('laporan.keuangan*') ? 'active' : ''); ?>">
            <a class="nav-link" href="<?php echo e(route('laporan.keuangan')); ?>">
        ...
        <!-- Nav Item - QRIS -->
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('qris.embed')); ?>" target="_blank">
                <i class="fas fa-fw fa-qrcode"></i>
                <span>QRIS Donasi</span>
            </a>
        </li>
        ...
        <!-- Nav Item - Profile -->
        <li class="nav-item <?php echo e(request()->routeIs('profile') ? 'active' : ''); ?>">
    ...
    <footer class="sticky-footer">
        <div class="container my-auto">
            <div class="copyright text-center my-auto">
                ...
                <?php else: ?>
                <span>
                    <i class="far fa-copyright"></i> <?php echo e(now()->year); ?> 
...
</html><?php /**PATH F:\PROJECT LARAVEL\MASJID-DIGITAL-V2\resources\views/layouts/admin.blade.php ENDPATH**/ ?>