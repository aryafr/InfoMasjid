...
<div class="container-fluid">
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		...
		<div>
			<a href="<?php echo e(route('rotator')); ?>" class="btn btn-primary" target="_blank">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			<form method="POST" action="<?php echo e(route('rotation.update')); ?>">
				<?php echo csrf_field(); ?>
				...
				<div class="form-group">
					...
					<label class="switch">
						<input type="checkbox" name="rotation_enabled" value="1" <?php echo e($setting->rotation_enabled ? 'checked' : ''); ?>>
				...
				<div class="form-group">
					...
					<input type="number" name="rotation_interval" class="form-control" value="<?php echo e($setting->rotation_interval); ?>" min="1" max="3600" required>
				...
				<div class="table-responsive">
					<table class="table table-bordered">
						...
						<tbody>
							...
							<?php $__currentLoopData = $availablePages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php
							$isActive = false;
							...
							<tr>
								<td class="text-center">
									<input type="checkbox" name="active_pages[]" value="<?php echo e($page['url']); ?>" 
									<?php echo e($isActive ? 'checked' : ''); ?>>
								</td>
								<td><strong><?php echo e($page['name']); ?></strong></td>
								<td><code><?php echo e($page['url']); ?></code></td>
								<td><small class="text-muted"><?php echo e($page['desc']); ?></small></td>
							</tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\PROJECT LARAVEL\MASJID-DIGITAL-V2\resources\views\rotation\index.blade.php ENDPATH**/ ?>