...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		...
		<div>
			<a href="<?php echo e(route('jadwal_sholat.create')); ?>" class="btn btn-primary btn-sm shadow-sm">
			...
			<div class="btn-group ml-2">
				...
				<div class="dropdown-menu dropdown-menu-right">
					<a class="dropdown-item" href="<?php echo e(route('export.jadwal-sholat', ['type' => 'excel'])); ?>">
						<i class="fas fa-file-excel text-success"></i> Export ke Excel
					</a>
					<a class="dropdown-item" href="<?php echo e(route('export.jadwal-sholat', ['type' => 'pdf'])); ?>">
					...
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<div class="h5 mb-0 font-weight-bold text-gray-800">
								...
								?>
								<?php echo e($subuh ? \Carbon\Carbon::parse($subuh->waktu)->format('H:i') : '--:--'); ?>
					...
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<div class="h5 mb-0 font-weight-bold text-gray-800">
								...
								?>
								<?php echo e($dzuhur ? \Carbon\Carbon::parse($dzuhur->waktu)->format('H:i') : '--:--'); ?>
					...
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<div class="h5 mb-0 font-weight-bold text-gray-800">
								...
								?>
								<?php echo e($ashar ? \Carbon\Carbon::parse($ashar->waktu)->format('H:i') : '--:--'); ?>
					...
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<div class="h5 mb-0 font-weight-bold text-gray-800">
								...
								?>
								<?php echo e($maghrib ? \Carbon\Carbon::parse($maghrib->waktu)->format('H:i') : '--:--'); ?>
					...
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<div class="h5 mb-0 font-weight-bold text-gray-800">
								...
								?>
								<?php echo e($isya ? \Carbon\Carbon::parse($isya->waktu)->format('H:i') : '--:--'); ?>
				...
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($jadwal->count()); ?></div>
						</div>
						<div class="col-auto">
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<div class="icon-circle bg-<?php echo e($item->nama_sholat == 'Subuh' ? 'primary' : 
										($item->nama_sholat == 'Dzuhur' ? 'success' : 
										($item->nama_sholat == 'Ashar' ? 'info' : 
										($item->nama_sholat == 'Maghrib' ? 'warning' : 'danger')))); ?> text-white mr-3" style="width: 35px; height: 35px; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
									<i class="fas fa-mosque"></i>
								</div>
								<div>
									<strong><?php echo e($item->nama_sholat); ?></strong>
								</div>
							</div>
						</td>
						<td>
							<span class="badge badge-dark p-2" style="font-size: 14px;">
								<i class="fas fa-clock"></i> <?php echo e(\Carbon\Carbon::parse($item->waktu)->format('H:i')); ?> WIB
							</span>
						</td>
						<td>
							<?php if($isNext && $diffMinutes <= 60 && $diffMinutes > 0): ?>
								<span class="badge badge-warning">
									<i class="fas fa-hourglass-half"></i> Akan datang dalam <?php echo e($diffMinutes); ?> menit
								</span>
								<?php elseif($isNext): ?>
							...
							<td class="text-center">
								<a href="<?php echo e(route('jadwal_sholat.edit', $item)); ?>" class="btn btn-sm btn-warning" data-toggle="tooltip" title="Edit">
									<i class="fas fa-edit"></i>
								</a>
								<form action="<?php echo e(route('jadwal_sholat.destroy', $item)); ?>" method="POST" class="d-inline delete-form">
									<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\PROJECT LARAVEL\MASJID-DIGITAL-V2\resources\views\jadwal_sholat\index.blade.php ENDPATH**/ ?>