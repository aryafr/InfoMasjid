...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			<form action="<?php echo e(route('idul-fitri.update', $idulFitri)); ?>" method="POST">
				<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
							value="<?php echo e(old('tahun', $idulFitri->tahun)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
							value="<?php echo e(old('tanggal', $idulFitri->tanggal->format('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
							value="<?php echo e(old('imam', $idulFitri->imam)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
							value="<?php echo e(old('khatib', $idulFitri->khatib)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
							value="<?php echo e(old('muadzin', $idulFitri->muadzin)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
							value="<?php echo e(old('waktu', $idulFitri->waktu ? \Carbon\Carbon::parse($idulFitri->waktu)->format('H:i') : '07:00')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
							value="<?php echo e(old('keterangan', $idulFitri->keterangan)); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\PROJECT LARAVEL\MASJID-DIGITAL-V2\resources\views\idul-fitri\edit.blade.php ENDPATH**/ ?>