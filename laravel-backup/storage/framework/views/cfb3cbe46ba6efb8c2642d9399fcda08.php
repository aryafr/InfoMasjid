...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			<form action="<?php echo e(route('qris.store')); ?>" method="POST" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
							value="<?php echo e(old('bank')); ?>" placeholder="Contoh: Bank Syariah Indonesia">
...
unset($__errorArgs, $__bag); ?>" 
							value="<?php echo e(old('atas_nama')); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\PROJECT LARAVEL\MASJID-DIGITAL-V2\resources\views/qris/create.blade.php ENDPATH**/ ?>