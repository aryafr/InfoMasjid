...
unset($__errorArgs, $__bag); ?>" 
								id="tanggal" name="tanggal" value="<?php echo e(old('tanggal', $keuangan->tanggal)); ?>" required>
							</div>
...
unset($__errorArgs, $__bag); ?>" 
								id="deskripsi" name="deskripsi" value="<?php echo e(old('deskripsi', $keuangan->deskripsi)); ?>" required>
							</div>
...
unset($__errorArgs, $__bag); ?>" id="kategori" name="kategori">
									<option value="" <?php echo e(old('kategori', $keuangan->kategori) == '' ? 'selected' : ''); ?>>- Pilih Kategori -</option>
									<option value="Infak" <?php echo e(old('kategori', $keuangan->kategori) == 'Infak' ? 'selected' : ''); ?>>Infak</option>
									<option value="Sumbangan" <?php echo e(old('kategori', $keuangan->kategori) == 'Sumbangan' ? 'selected' : ''); ?>>Sumbangan</option>
									<option value="Donatur" <?php echo e(old('kategori', $keuangan->kategori) == 'Donatur' ? 'selected' : ''); ?>>Donatur Tetap</option>
									<option value="Zakat" <?php echo e(old('kategori', $keuangan->kategori) == 'Zakat' ? 'selected' : ''); ?>>Zakat</option>
									...
									<option value="Kegiatan" <?php echo e(old('kategori', $keuangan->kategori) == 'Kegiatan' ? 'selected' : ''); ?>>Kegiatan</option>
									<option value="Utilitas" <?php echo e(old('kategori', $keuangan->kategori) == 'Utilitas' ? 'selected' : ''); ?>>Utilitas</option>
								</select>
							</div>
...
unset($__errorArgs, $__bag); ?>" 
										id="pemasukan" name="pemasukan" step="1" value="<?php echo e(old('pemasukan', $keuangan->pemasukan)); ?>">
									</div>
...
unset($__errorArgs, $__bag); ?>" 
										id="pengeluaran" name="pengeluaran" step="1" value="<?php echo e(old('pengeluaran', $keuangan->pengeluaran)); ?>">
									</div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\PROJECT LARAVEL\MASJID-DIGITAL-V2\resources\views\keuangan\edit.blade.php ENDPATH**/ ?>