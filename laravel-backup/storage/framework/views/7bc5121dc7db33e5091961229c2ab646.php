...
<div class="container-fluid">
	...
	<div class="alert alert-info">
		...
		Current City in Database: <?php echo e($setting->auto_update_city ?? 'Not set'); ?><br>
		Current Country: <?php echo e($setting->auto_update_country ?? 'Not set'); ?><br>
		Last Updated: <?php echo e($setting->updated_at ?? 'Never'); ?>
	...
	<div class="row">
		<div class="col-lg-8">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<form action="<?php echo e(route('auto_update.settings')); ?>" method="POST" id="autoUpdateForm">
						<?php echo csrf_field(); ?>
						...
						<div id="autoUpdateOptions" style="<?php echo e($setting->auto_update_jadwal ? '' : 'display: none;'); ?>">
							<div class="form-group">
								...
								<select class="form-control" id="auto_update_frequency" name="auto_update_frequency">
									<option value="daily" <?php echo e(($setting->auto_update_frequency ?? 'daily') == 'daily' ? 'selected' : ''); ?>>
										Harian
									</option>
									<option value="weekly" <?php echo e(($setting->auto_update_frequency ?? '') == 'weekly' ? 'selected' : ''); ?>>
										Mingguan
									</option>
									<option value="monthly" <?php echo e(($setting->auto_update_frequency ?? '') == 'monthly' ? 'selected' : ''); ?>>
										Bulanan
									</option>
								</select>
								<small class="form-text text-muted">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										name="auto_update_city" value="<?php echo e(old('auto_update_city', $setting->auto_update_city ?? 'Jakarta')); ?>"
										placeholder="Contoh: Cilegon, Jakarta, Bandung" required>
										<small class="text-muted">Current value: <?php echo e($setting->auto_update_city ?? 'Jakarta'); ?></small>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										name="auto_update_country" value="<?php echo e(old('auto_update_country', $setting->auto_update_country ?? 'Indonesia')); ?>"
							...
							<div class="form-group">
								...
								<select class="form-control" id="auto_update_method" name="auto_update_method">
									<option value="11" <?php echo e(($setting->auto_update_method ?? 11) == 11 ? 'selected' : ''); ?>>
										Kementerian Agama RI (Metode 11)
									</option>
									<option value="20" <?php echo e(($setting->auto_update_method ?? 11) == 20 ? 'selected' : ''); ?>>
										Kementerian Agama RI (Metode 20)
									</option>
									<option value="1" <?php echo e(($setting->auto_update_method ?? 11) == 1 ? 'selected' : ''); ?>>
										University of Islamic Sciences, Karachi
									</option>
									<option value="2" <?php echo e(($setting->auto_update_method ?? 11) == 2 ? 'selected' : ''); ?>>
										Islamic Society of North America
									</option>
									<option value="3" <?php echo e(($setting->auto_update_method ?? 11) == 3 ? 'selected' : ''); ?>>
										Muslim World League
									</option>
									<option value="4" <?php echo e(($setting->auto_update_method ?? 11) == 4 ? 'selected' : ''); ?>>
										Umm Al-Qura University, Makkah
									</option>
									<option value="5" <?php echo e(($setting->auto_update_method ?? 11) == 5 ? 'selected' : ''); ?>>
							...
							<div class="alert alert-info">
								...
								<strong><span id="displayCity"><?php echo e($setting->auto_update_city ?? 'Jakarta'); ?></span>, <span id="displayCountry"><?php echo e($setting->auto_update_country ?? 'Indonesia'); ?></span></strong> 
						...
						<div class="form-group">
							...
							<a href="<?php echo e(route('jadwal_sholat.index')); ?>" class="btn btn-secondary">
		...
		<div class="col-lg-4">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					...
					<p class="mt-2 small">
						<i class="fas fa-clock"></i> Update <?php echo e($setting->auto_update_frequency ?? 'harian'); ?> 
						pukul <?php echo e(substr($setting->auto_update_time ?? '00:00:00', 0, 5)); ?><br>
						<i class="fas fa-map-marker-alt"></i> <?php echo e($setting->auto_update_city ?? 'Jakarta'); ?>, 
						<?php echo e($setting->auto_update_country ?? 'Indonesia'); ?>
					...
					<p class="small mb-0">
						<strong>ID Record:</strong> <?php echo e($setting->id); ?><br>
						<strong>Last Update:</strong> <?php echo e($setting->updated_at ? $setting->updated_at->format('d M Y H:i:s') : 'Never'); ?><br>
						<strong>City in DB:</strong> <?php echo e($setting->auto_update_city ?? 'Not set'); ?>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content border-0 shadow-lg">
					...
					<div class="card-body p-3">
						...
						<div class="row">
							<div class="col-6">
								...
								<span class="font-weight-bold" id="modalCity"><?php echo e($setting->auto_update_city ?? 'Jakarta'); ?></span>
							</div>
							<div class="col-6">
								<small class="text-muted d-block">Negara</small>
								<span class="font-weight-bold" id="modalCountry"><?php echo e($setting->auto_update_country ?? 'Indonesia'); ?></span>
							</div>
						</div>
						<hr class="my-2">
						<div class="row">
							...
							<div class="col-6">
								...
								<span class="font-weight-bold"><?php echo e($setting->last_auto_update ? $setting->last_auto_update->format('d M Y H:i') : 'Belum pernah'); ?></span>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="modal-footer border-0 bg-light">
				...
				<a href="<?php echo e(route('auto_update.manual')); ?>" class="btn btn-warning px-4" id="confirmUpdateBtn">
...
<script>
    ...
    // Load update log
			function loadUpdateLog() {
				fetch('<?php echo e(route("auto_update.log")); ?>')
				.then(response => response.json())
				.then(data => {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\PROJECT LARAVEL\MASJID-DIGITAL-V2\resources\views/auto_update/index.blade.php ENDPATH**/ ?>